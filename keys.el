...
(map! :leader  "j"  #'org-journal-open-current-journal-file)    ; (M)-SPC j for journal
(map! :leader "M-;" #'comment-line)     ; Don't need to take finger off of M key.
...
;;; <failed attempt at adding to local-leader> I wanted to something like
...
;; TODO MAP     Oli's private keymap. C-o?
;; TODO FUNC    demote and next line possible pairing:
;; TODO MAP     C-down to swap lines
