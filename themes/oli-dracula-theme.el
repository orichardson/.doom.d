;;; oli-dracula-theme.el - based on https://draculatheme.com/ -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup oli-dracula-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom oli-dracula-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'oli-dracula-theme
  :type 'boolean)

(defcustom oli-dracula-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'oli-dracula-theme
  :type 'boolean)

(defcustom oli-dracula-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'oli-dracula-theme
  :type 'boolean)

(defcustom oli-dracula-comment-bg oli-dracula-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'oli-dracula-theme
  :type 'boolean)

(defcustom oli-dracula-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme oli-dracula
  ...
  ((bg         '("#282a36" "#262626" nil            ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if oli-dracula-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if oli-dracula-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level6 (if oli-dracula-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if oli-dracula-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if oli-dracula-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if oli-dracula-colorful-headers violet  (doom-lighten violet 0.95)))

   (hidden     base1)
   (-modeline-bright oli-dracula-brighter-modeline)
   (-modeline-pad
    (when oli-dracula-padded-modeline
      (if (integerp oli-dracula-padded-modeline) oli-dracula-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if oli-dracula-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; oli-dracula-theme.el ends here
